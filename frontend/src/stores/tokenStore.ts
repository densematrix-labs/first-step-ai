 ...
 * Copy to: src/stores/tokenStore.ts
 * Dependency: npm install zustand
 * Customize: localStorage key name in `persist({ name: ... })`
 */
...
export const useTokenStore = create<TokenState>()(
  persist(
    ...
    { name: 'app-tokens' } // ← customize this key per project
  )
)
